...
> ⏰ Última actualización: 2026-06-13 07:22 (UTC+8)
...
| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-5qI6Gyzctu4DKJNSAZyoRppiy5AUFNeZhHZINJ3uPPcN7Fwb` | kimi-k2.5 | 🆕 Nueva | $2 | 10 RPM | 2026-06-14 | Kimi long-context general model |
| `sk-MtLh6LWmQdtpylbqIGNx8AuEtR6ITgzquflhnqzzeALxTdmh` | kimi-k2.5 | 🆕 Nueva | $5 | 10 RPM | 2026-06-14 | Kimi long-context general model |

### Image / Audio / Embedding `06-13 07:22`
