...
| Key | モデル | ステータス | 予算 | レート | 有効期限 | 説明 |
|-----|--------|------------|------|--------|----------|------|
| `sk-DpwzSAfPlKX8F1tTJxUHlzH5SvwvBEI1ClqwvnLpWqcdQbk1` | deepseek-chat | 🆕 新規 | $19 | 20 RPM | 2026-05-28 | Everyday chat, coding, translation, writing |

### マルチモデル (GPT-5.5 / Claude / DeepSeek / Gemini 自動ルーティング) `05-26 15:22`
