...
> ⏰ Última atualização: 2026-05-31 02:52 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `05-31 02:52`
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-TUnLku70RsnFjSpq7ghqBufEHczKp7GQMbmwvaWCRe4e7vkX` | kimi-k2.5 | 🆕 Nova | $19 | 10 RPM | 2026-06-01 | Kimi long-context general model |

### Image / Audio / Embedding `05-31 02:52`
