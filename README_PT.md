...
> ⏰ Última atualização: 2026-06-14 22:30 (UTC+8)

### Modelos em destaque

### Claude Opus 4.7 `06-14 22:30`
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-14 22:30`
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-3EiirowRPaIRCNJhmSA5oBefWic3wcSqTVUIv5qD7EKDLmff` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-16 | Kimi long-context general model |
| `sk-nAv3CO3gtY8LyqPG9291MyUyMMKRw7Va2w6oYZmQf4L3jVT9` | kimi-k2.5 | 🆕 Nova | $9 | 10 RPM | 2026-06-16 | Kimi long-context general model |

### Image / Audio / Embedding `06-14 22:30`
